    ...
    <div>
      ...
      <div className="cart-wrapper">
        ...
        <div className="btn-wrapper item">
          <button
            onClick={() =>
              props.addToCartHandler({ price: 100, name: "Iphone x" })
            }
          >
            Add to Cart
          </button>
